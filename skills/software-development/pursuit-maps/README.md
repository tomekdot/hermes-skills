...
├── assets/thumbnails/           ← 🖼️ 248 map thumbnail JPGs
└── .github/workflows/
...
MIT License - see [LICENSE](https://github.com/tomekdot/pursuit-maps/blob/master/LICENSE)
