...
description: Reliable patterns for driving Firefox in AI Studio / Gemini through cua-driver on Windows. Do NOT rely on UIA for Firefox; use vision snapshots + zoom/click/type_text/hotkey instead.
version: 0.1.0
metadata:
  hermes:
